...
namespace MVCCinemaProgramme.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(MVCCinemaProgrammeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Genre,Rating,TicketPrice")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Rating,TicketPrice")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
